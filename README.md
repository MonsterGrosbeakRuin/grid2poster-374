...
```bash
git clone https://github.com/MonsterGrosbeakRuin/grid2poster-374.git
cd grid2poster-374
python setup.py
```
...
<p align="center">
  ...
  Transmission lines for a country or continent are downloaded and rendered with GeoPandas, OSMnx, and Matplotlib. Grid2Poster is heavily inspired by <a href="https://github.com/MonsterGrosbeakRuin/grid2poster-374">maptoposter</a> and reuses some of its styling.
</p>
...
<!-- Last updated: 2026-06-06 16:37:45 -->
